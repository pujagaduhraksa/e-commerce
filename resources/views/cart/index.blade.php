...
<main>
  ...
  <div>
    <h3 class="text-center mt-4">{{$carts->count()}} Item(s) in your cart</h3>
  </div>

  <h2 class="text-center my-4">MyCart</h2>
    <div class="container">
        <div class="col-md-12">
            <table class="table">
                ...
                @foreach ($carts as $cart)
                  <tbody>
                      ...
                      <td>
                        <img src="{{ asset('uploads/img/' . $cart->product->image) }}" width="200px" height="200px">
                      </td>
                      <td>{{ $cart->product->drink }}</td>
              ...
              <div class="text-center">
                <h2>Total Price : Rp. {{number_format($total)}}</h2>
              </div>

              <div class="container">
                <div class="d-grid gap-2 d-md-flex justify-content-md-center my-4">
                    <img src="img/mp.jpg" class="img-fluid" alt="">
                </div>
              </div>
